...
public class AddToWish extends HttpServlet implements Shop{
    int wishCount = 0;
    ...
    throws ServletException, IOException {
        ...
        operations.addToWish();
        wishCount = operations.getWishCount();
        ...
        if(forward){
            ...
            try ( PrintWriter out = response.getWriter()) {
                out.println(ShopUtil.buildWishJson("wishCount", ""+wishCount));
            }
        }
