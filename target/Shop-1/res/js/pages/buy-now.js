...
$(function(){
    $('.btnB button').click(placeBuyNowOrder);
});

function placeBuyNowOrder(){
    var shipAddr = document.forms.shipAddr; // Or document.forms['shipAddr']
    var billAddr = document.forms.billAddr;

    let addrForm = new Form("http://localhost:8080/Shop/authorize/BuyNow", "POST");
    ...
    console.log(addrForm.getNameValueString());
    addrForm.submit();
}
